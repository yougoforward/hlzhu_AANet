...
class psaa34_Module(nn.Module):
    def __init__(self, in_channels, out_channels, atrous_rates, norm_layer, up_kwargs):
        ...
        self.b4 = psaa34Conv(in_channels, out_channels, rate4, norm_layer)
        self.b5 = psaa34Conv(in_channels, out_channels, rate5, norm_layer)

        self.b6 = psaa34Pooling(in_channels, out_channels, norm_layer, up_kwargs)
